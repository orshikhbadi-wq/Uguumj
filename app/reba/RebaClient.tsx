...
export default function RebaClient() {
  ...
  return <main className="reba-page"><style>{`
    .reba-page{background:#FFFFFF;color:#1A1A1A;min-height:100vh;font-family:"Uguumj Manrope",Arial,sans-serif}
    .reba-page *{box-sizing:border-box}.reba-page a{text-decoration:none;color:inherit}.reba-header{height:84px;padding:0 clamp(24px,6vw,96px);display:flex;align-items:center;justify-content:space-between;gap:28px;position:absolute;z-index:2;top:0;left:0;right:0;color:#FFFFFF}.reba-logo{display:flex;flex-direction:column;line-height:1;letter-spacing:.14em;font-weight:700;font-size:14px}.reba-logo small{font-size:8px;letter-spacing:.27em;margin-top:7px;opacity:.72}.reba-header nav{display:flex;gap:28px;font-size:12px;letter-spacing:.1em;text-transform:uppercase}.reba-header nav a{opacity:.84;transition:opacity .2s}.reba-header nav a:hover{opacity:1}.reba-language{display:flex;gap:5px}.reba-language button{border:1px solid rgba(255,255,255,.45);background:transparent;color:#FFFFFF;border-radius:999px;padding:7px 10px;font-size:11px;cursor:pointer}.reba-language button.active{background:#FFFFFF;color:#1A1A1A;border-color:#FFFFFF}
    .reba-hero{min-height:760px;display:flex;align-items:flex-end;padding:150px clamp(24px,10vw,160px) 92px;position:relative;background-image:url('${heroImage}');background-size:cover;background-position:center}.reba-hero:after{content:"";position:absolute;inset:auto 0 0;height:30%;background:#1A1A1A;opacity:.4}.reba-hero-content{position:relative;z-index:1;max-width:760px;color:#FFFFFF}.reba-eyebrow{font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#C98A3D;margin:0 0 24px}.reba-hero h1,.reba-section h2{font-family:"Uguumj Noto Serif",Georgia,serif;font-weight:500;white-space:pre-line;letter-spacing:-.025em}.reba-hero h1{font-size:clamp(48px,7vw,104px);line-height:1.02;margin:0 0 28px}.reba-hero p:not(.reba-eyebrow){font-size:18px;line-height:1.75;max-width:590px;color:rgba(255,255,255,.84);margin:0}.reba-actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:34px}.reba-button{display:inline-flex;align-items:center;justify-content:center;padding:14px 20px;border:1px solid rgba(255,255,255,.6);font-size:11px;letter-spacing:.14em;text-transform:uppercase;transition:all .2s}.reba-button.primary{background:#F00028;color:#FFFFFF;border-color:#F00028}.reba-button:hover{transform:translateY(-2px)}
    .reba-section{padding:clamp(76px,10vw,150px) clamp(24px,10vw,160px)}.reba-intro{display:grid;grid-template-columns:1fr 1.05fr;gap:clamp(42px,8vw,130px);align-items:center}.reba-section h2{font-size:clamp(38px,5vw,72px);line-height:1.08;margin:0 0 28px}.reba-copy{font-size:17px;line-height:1.85;color:#5C3C2B;max-width:580px;margin:0}.reba-kicker{color:#C98A3D;font-size:11px;letter-spacing:.2em;text-transform:uppercase;margin:0 0 22px}.reba-image{min-height:520px;background-size:cover;background-position:center;border-radius:2px;box-shadow:26px 26px 0 #C98A3D}
    .reba-services{background:#1A1A1A;color:#FFFFFF}.reba-services .reba-kicker{color:#C98A3D}.reba-services h2{max-width:650px}.reba-service-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:rgba(255,255,255,.25);margin-top:64px}.reba-service{background:#1A1A1A;padding:32px 28px 38px;min-height:235px}.reba-service-number{font-family:"Uguumj Noto Serif",serif;color:#C98A3D;font-size:30px}.reba-service h3{font-family:"Uguumj Noto Serif",serif;font-weight:500;font-size:30px;margin:34px 0 14px}.reba-service p{font-size:14px;line-height:1.75;color:rgba(255,255,255,.72);margin:0}
    .reba-menu{display:grid;grid-template-columns:1.1fr .9fr;gap:clamp(42px,8vw,130px);align-items:center}.reba-menu-art{min-height:430px;background-image:url('/legacy/assets/products-texture-Def4-lGY.jpg');background-size:cover;background-position:center}.reba-menu-list{border-top:1px solid #F1EBDD;margin-top:32px}.reba-menu-item{display:flex;justify-content:space-between;gap:20px;padding:18px 0;border-bottom:1px solid #F1EBDD;font-size:14px}.reba-menu-item span:last-child{color:#C98A3D}
    .reba-visit{background:#F1EBDD;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:end}.reba-visit h2{margin-bottom:0}.reba-contact{border-top:1px solid #F1EBDD}.reba-contact-row{display:flex;justify-content:space-between;gap:24px;padding:18px 0;border-bottom:1px solid #F1EBDD;font-size:14px}.reba-contact-row span:first-child{color:#5C3C2B;font-size:11px;letter-spacing:.16em;text-transform:uppercase}.reba-footer{background:#1A1A1A;color:#FFFFFF;padding:34px clamp(24px,6vw,96px);display:flex;justify-content:space-between;gap:20px;font-size:12px}.reba-footer span:last-child{color:#C98A3D}
    @media(max-width:760px){.reba-header{height:72px}.reba-header nav{display:none}.reba-hero{min-height:700px;padding:130px 24px 64px}.reba-hero h1{font-size:52px}.reba-hero p:not(.reba-eyebrow){font-size:15px}.reba-intro,.reba-menu,.reba-visit{grid-template-columns:1fr}.reba-image{min-height:360px;box-shadow:14px 14px 0 #C98A3D}.reba-service-grid{grid-template-columns:1fr;margin-top:40px}.reba-service{min-height:auto}.reba-section{padding:78px 24px}.reba-footer{flex-direction:column}}
  `}</style><Header lang={lang} setLang={setLang} t={t} /><section className="reba-hero"><ScrollReveal from="left" duration={900} className="reba-hero-content"><p className="reba-eyebrow">{editable.eyebrow || t.eyebrow}</p><h1>{editable.title || t.title}</h1><p>{intro}</p><div className="reba-actions"><a className="reba-button primary" href="#cafe">{t.discover}</a><a className="reba-button" href={`tel:${phone.replace(/[^0-9+]/g, "")}`}>{t.contact}</a></div></ScrollReveal></section><section className="reba-section reba-intro" id="cafe"><ScrollReveal from="left" duration={760}><div><p className="reba-kicker">{t.storyEyebrow}</p><h2>{t.storyTitle}</h2><p className="reba-copy">{editable.description || t.storyBody}</p></div></ScrollReveal><ScrollReveal from="right" delay={120} duration={760}><div className="reba-image" style={{ backgroundImage: `url('${heroImage}')` }} /></ScrollReveal></section><section className="reba-section reba-services" id="hall"><ScrollReveal from="bottom"><p className="reba-kicker">{t.eyebrow}</p><h2>{t.menuTitle}</h2></ScrollReveal><div className="reba-service-grid"><ScrollReveal from="left"><article className="reba-service"><span className="reba-service-number">01</span><h3>{t.cafeTitle}</h3><p>{t.cafeBody}</p></article></ScrollReveal><ScrollReveal from="bottom" delay={90}><article className="reba-service"><span className="reba-service-number">02</span><h3>{t.hallTitle}</h3><p>{t.hallBody}</p></article></ScrollReveal><ScrollReveal from="right" delay={180}><article className="reba-service"><span className="reba-service-number">03</span><h3>{t.bakeryTitle}</h3><p>{t.bakeryBody}</p></article></ScrollReveal></div></section><section className="reba-section reba-menu"><ScrollReveal from="left"><div className="reba-menu-art" /></ScrollReveal><ScrollReveal from="right" delay={100}><div><p className="reba-kicker">{t.menuEyebrow}</p><h2>{t.menuTitle}</h2><p className="reba-copy">{t.menuBody}</p><div className="reba-menu-list">{t.menuItems.map((item) => <div className="reba-menu-item" key={item}><span>{item}</span><span>✦</span></div>)}</div></div></ScrollReveal></section><section className="reba-section reba-visit" id="visit"><ScrollReveal from="left"><div><p className="reba-kicker">{t.visitEyebrow}</p><h2>{t.visitTitle}</h2></div></ScrollReveal><ScrollReveal from="right" delay={100}><div className="reba-contact"><div className="reba-contact-row"><span>{t.addressLabel}</span><span>{address}</span></div><div className="reba-contact-row"><span>{t.phoneLabel}</span><a href={`tel:${phone.replace(/[^0-9+]/g, "")}`}>{phone}</a></div><div className="reba-contact-row"><span>{t.emailLabel}</span><a href={`mailto:${email}`}>{email}</a></div><a className="reba-button" style={{ marginTop: 26, borderColor: "#F00028", color: "#F00028" }} href="https://maps.google.com/?q=Өгөөмж+Архад+ХХК" target="_blank" rel="noreferrer">{t.directions}</a></div></ScrollReveal></section><footer className="reba-footer"><span>REBA VINTAGE CAFE</span><span>{t.footer}</span></footer></main>;
}
