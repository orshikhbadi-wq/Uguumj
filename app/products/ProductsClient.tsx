...
export default function ProductsClient() {
  ...
  return (
    <main className="products-page">
      <style>{`
        .products-page{min-height:100vh;background:#FFFFFF;color:#1A1A1A;font-family:"Uguumj Manrope",Arial,sans-serif}
        ...
        .products-header{height:92px;padding:0 clamp(24px,3.2vw,62px);display:grid;grid-template-columns:150px 1fr auto;align-items:center;gap:24px;position:sticky;top:0;z-index:40;background:#FFFFFF;border-bottom:1px solid rgba(26,26,26,.12)}
        ...
        .products-eyebrow{font-size:10px;letter-spacing:.2em;font-weight:700;color:#C98A3D;margin:0 0 24px}.products-title{font-family:"Uguumj Noto Serif",Georgia,serif;font-weight:400;font-size:clamp(46px,5.4vw,78px);line-height:1.05;letter-spacing:-.035em;margin:0}.products-title em{display:block;color:#F00028;font-weight:400}.products-intro{font-size:16px;line-height:1.65;color:#5C3C2B;max-width:390px;margin:0 0 8px}
        .products-controls{border-bottom:1px solid #F1EBDD;padding:0 0 26px;display:flex;align-items:center;justify-content:space-between;gap:24px}
        .filter-chips{display:flex;align-items:center;gap:10px;flex-wrap:wrap}
        .filter-chip{border:1px solid #F1EBDD;background:transparent;color:#5C3C2B;border-radius:999px;padding:10px 17px;font-size:9px;font-weight:700;letter-spacing:.12em;cursor:pointer;transition:background .2s,color .2s,border-color .2s}
        .filter-chip:hover,.filter-chip.active{background:#F00028;color:#FFFFFF;border-color:#F00028}
        .product-search{width:min(300px,100%);display:flex;align-items:center;gap:9px;border:1px solid #F1EBDD;border-radius:999px;padding:10px 15px;background:#FFFFFF}
        .product-search span{font-size:18px;color:#5C3C2B}.product-search input{width:100%;border:0;outline:0;background:transparent;color:#1A1A1A;font-size:11px}.product-search input::placeholder{color:#5C3C2B}
        .products-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:28px}.product-card-reveal{height:100%}
        .product-card{border:1px solid #F1EBDD;background:#FFFFFF;border-radius:12px;overflow:hidden;transition:transform .28s,box-shadow .28s}
        .product-card:hover{transform:translateY(-4px);box-shadow:0 18px 46px rgba(26,26,26,.09)}
        .product-image-wrap{position:relative;aspect-ratio:1.62/1;overflow:hidden;background:#F1EBDD}
        ...
        .featured-badge{position:absolute;top:13px;left:13px;background:#F00028;color:#FFFFFF;border-radius:4px;padding:7px 11px;font-size:8px;letter-spacing:.13em;font-weight:700}
        .product-card-body{position:relative;padding:15px 44px 16px 16px;border-top:1px solid #F1EBDD;background:#F1EBDD}
        .product-category{font-size:8px;letter-spacing:.16em;color:#C98A3D;text-transform:uppercase;margin:0 0 6px}
        ...
        .product-description{font-size:10px;line-height:1.45;color:#5C3C2B;min-height:28px;margin:0}
        ...
        .products-empty{padding:70px 0;text-align:center;color:#5C3C2B;font-size:14px}
        .wholesale-panel{margin-top:38px;border:1px solid #F1EBDD;border-radius:6px;padding:28px 36px;display:grid;grid-template-columns:80px 1fr auto;align-items:center;gap:24px;background:#FFFFFF}.wholesale-icon{width:58px;height:58px;border-radius:50%;display:grid;place-items:center;background:#F1EBDD;font-size:24px}.wholesale-panel h3{font-family:"Uguumj Noto Serif",Georgia,serif;font-size:25px;font-weight:400;margin:0 0 7px}.wholesale-panel p{font-size:11px;color:#5C3C2B;margin:0;line-height:1.55}.wholesale-button{background:#F00028;color:#FFFFFF!important;border-radius:5px;padding:17px 27px;font-size:10px;letter-spacing:.14em;font-weight:700;display:inline-flex;gap:22px;align-items:center}
      ...
      <div className="products-shell">
        ...
        <ScrollReveal from="bottom" delay={100} duration={760}>
          <aside className="wholesale-panel">
            ...
            <a className="wholesale-button" href="/store">{t.wholesaleCta}<span>→</span></a>
          </aside>
        </ScrollReveal>
      </div>
    </main>
